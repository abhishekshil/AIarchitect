  ...
  if (!projectId || !requirementId) {
    return (
      <div className="mx-auto max-w-5xl">
        ...
        <Link href="/projects" className="mt-4 inline-block text-sm text-emerald-700">
          ← Projects
        </Link>
      </div>
    );
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
            Work through setup tasks for your selected architecture. Requirement{' '}
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          ...
          <Link href={`/projects/${projectId}/requirements/new`} className="text-zinc-600 hover:underline">
            Requirement text
          </Link>
          <Link href="/projects" className="text-zinc-600 hover:underline">
            All projects
          </Link>
        </div>
      </div>
